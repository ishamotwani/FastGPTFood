        ...
        <div>
            ...
            <div>
                {menuItems.map((item, index) => (
                    <button key={index} onClick={() => addThenChecksSize(item)}>{item}</button>
                ))}
            </div>
        </div>
    );
        ...
        <div>
            ...
            <div>
                {sizeItems.map((size, index) => (
                    <button key={index} onClick={() => finalAdd(index)}>{size}</button>
                ))}
            </div>
        </div>
    );
...
function Order ({addItem, setCostArray, setCost}) {
    ...
    return (
        ...
        {showItemsSizes ? (
            ...
            <div>
                <MenuView menuItems={menuItems} addThenChecksSize={addThenChecksSize}/> 
            </div>
        )}

        {addedTrigger && <div><p>{addedText}</p></div>}
    </div>
            <div>
            <CartButton />
            </div>
